...
namespace Backend.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Simplified Sensor Data Interval Configuration
            modelBuilder.Entity<SensorDataIntervalConfig>(entity =>
            {
                entity.HasKey(e => e.Id);
                entity.Property(e => e.Name).IsRequired().HasMaxLength(100);
                entity.Property(e => e.Description).HasMaxLength(500);
                entity.Property(e => e.SaveIntervalMinutes).IsRequired().HasDefaultValue(15);
                entity.Property(e => e.IsEnabled).IsRequired().HasDefaultValue(true);
                entity.Property(e => e.IsGlobalConfiguration).IsRequired().HasDefaultValue(false);
                entity.Property(e => e.CreatedBy).IsRequired();
                entity.Property(e => e.CreatedAt).IsRequired();
                entity.Property(e => e.UpdatedAt).IsRequired();
                entity.Property(e => e.IsActive).IsRequired().HasDefaultValue(true);
                ...
                entity.HasIndex(e => e.IsGlobalConfiguration);
                entity.HasIndex(e => e.DeviceId);
                entity.HasIndex(e => e.ContainmentId);
                entity.HasIndex(e => e.IsActive);
                entity.HasIndex(e => e.SaveIntervalMinutes);
                ...
                entity.HasIndex(e => new { e.ContainmentId, e.IsActive })
                      .IsUnique()
