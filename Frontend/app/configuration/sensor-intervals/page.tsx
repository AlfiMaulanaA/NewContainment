...
export default function SensorIntervalsPage() {
  // State
    ...
    try {
      ...
      try {
        ...
        if (configurationsResult.success && configurationsResult.data) {
          ...
          console.log('Loaded configurations:', configurationsResult.data)
        } else {
          console.warn('Failed to load configurations:', configurationsResult.message)
          setConfigurations([])
        }
      ...
      try {
        ...
        console.log('Intervals API response:', intervalsResult)
        if (intervalsResult.success && intervalsResult.data) {
          console.log('Setting intervals from API:', intervalsResult.data)
          setAvailableIntervals(intervalsResult.data)
        } else {
          console.warn('API intervals failed, keeping defaults:', intervalsResult)
        }
      } catch (intervalError) {
        console.error('Error loading intervals from API:', intervalError)
        console.log('Using default intervals as API failed')
  ...
  const handleQuickGlobalSet = async (intervalMinutes: number) => {
    try {
      ...
      console.error('Error setting global interval:', error)
      ...
      <SidebarInset>
        <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-semibold">Sensor Data Intervals</h1>
          </div>
        </header>
    ...
    <SidebarInset>
      ...
      <div className="flex-1 p-6 space-y-6">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="text-xl font-semibold">Interval Configuration</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  disabled={!!editingConfig} // Disable editing type for existing configs
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
