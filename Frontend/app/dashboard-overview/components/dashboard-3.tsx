...
import { Grid, Settings, Eye } from "lucide-react";
...
export default function Dashboard3({
  ...
  // Section components for Dashboard 3 compact layout - conditionally include CCTV section
