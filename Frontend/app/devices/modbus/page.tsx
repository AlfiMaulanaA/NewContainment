    ...
    <SidebarInset>
      <header className="flex h-16 items-center justify-between border-b px-4">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-semibold">Containment Device Monitoring</h1>
        </div>
        <div className="flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 m-4">
        ...
        <Card className="shadow-sm hover:shadow-md transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Total Containment Units</CardTitle>
            <Cpu className="h-5 w-5 text-green-600" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{devices.length}</div>
            <p className="text-xs text-muted-foreground">All monitoring units</p>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-sm hover:shadow-md transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Monitoring Breakdown</CardTitle>
        ...
        <Card className="shadow-sm hover:shadow-md transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Primary Protocol</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Main monitoring protocol</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="m-4">
        <CardHeader>
          <div className="flex justify-between items-center">
            <CardTitle>Containment Device List</CardTitle>
            <Input
              placeholder="Search containment devices..."
              value={searchQuery}
              ...
              {paginatedDevices.length > 0 ? (
                ...
                <TableRow>
                  <TableCell colSpan={6} className="text-center py-8 text-muted-foreground">
                    No containment devices found. Please check your configuration or refresh the list.
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
