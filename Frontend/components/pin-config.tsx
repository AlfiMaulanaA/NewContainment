    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Configure IoT pin assignments for optocoupler, relay, and relay mini modules
            </p>
          </div>
        </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <Button 
          ...
          disabled={!isConnectedStatus || !hasChanges || validationErrors.length > 0}
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleConfigChange('pir_sensor_pin', parseInt(e.target.value) || 1)}
                className="mt-1"
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleConfigChange('fss_pin', parseInt(e.target.value) || 1)}
                className="mt-1"
              />
            </div>
            
            <div>
              <Label htmlFor="smoke_sensor">Smoke Sensor/Emergency Button Pin</Label>
              <Input
                id="smoke_sensor"
                type="number"
                min="1"
                ...
                onChange={(e) => handleConfigChange('smoke_sensor_pin_button_emergency_pin', parseInt(e.target.value) || 1)}
                className="mt-1"
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleConfigChange('button_front_door_pin', parseInt(e.target.value) || 1)}
                className="mt-1"
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleConfigChange('button_back_door_pin', parseInt(e.target.value) || 1)}
                className="mt-1"
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleConfigChange('limit_switch_back_door_pin', parseInt(e.target.value) || 1)}
                className="mt-1"
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleConfigChange('limit_switch_front_door', parseInt(e.target.value) || 1)}
                className="mt-1"
              />
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleConfigChange('relay_light_pin', parseInt(e.target.value) || 1)}
                className="mt-1"
              />
            </div>
            
            <div>
              <Label htmlFor="relay_mag_back">Magnetic Back Door Relay Pin</Label>
              <Input
                id="relay_mag_back"
                type="number"
                min="1"
                ...
                onChange={(e) => handleConfigChange('relay_magnetic_back_door_pin', parseInt(e.target.value) || 1)}
                className="mt-1"
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleConfigChange('relay_magnetic_pin', parseInt(e.target.value) || 1)}
                className="mt-1"
              />
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleConfigChange('relay_mini_selenoid_open', parseInt(e.target.value) || 1)}
                className="mt-1"
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleConfigChange('relay_mini_selenoid_close', parseInt(e.target.value) || 1)}
                className="mt-1"
              />
            </div>
            
            <div>
              <Label htmlFor="mini_front_door" className="flex items-center gap-2">
                <DoorOpen className="h-4 w-4" />
                Front Door Pin
              </Label>
              <Input
                ...
                onChange={(e) => handleConfigChange('relay_mini_front_door_pin', parseInt(e.target.value) || 1)}
                className="mt-1"
              />
            </div>

            <div>
              <Label htmlFor="mini_back_door" className="flex items-center gap-2">
                <DoorOpen className="h-4 w-4" />
                Back Door Pin
              </Label>
              <Input
                ...
                onChange={(e) => handleConfigChange('relay_mini_back_door_pin', parseInt(e.target.value) || 1)}
                className="mt-1"
              />
            </div>

            <div>
              <Label htmlFor="mini_emergency" className="flex items-center gap-2">
              ...
              <Input
                ...
                onChange={(e) => handleConfigChange('relay_mini_door_emergency', parseInt(e.target.value) || 1)}
                className="mt-1"
              />
            </div>
          </CardContent>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center">
              ...
              <div className="text-sm text-muted-foreground">Optocoupler Pins</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-muted-foreground">Relay Mini Pins</div>
            </div>
            <div className="text-center">
              <div className={`text-2xl font-bold ${validationErrors.length === 0 ? 'text-green-600' : 'text-red-600'}`}>
